    ...
    <div className="stylist-page">
      <section className="chat-pane">
        ...
        <div className="chat-scroll">
          ...
          {stage === 'loading' && <div className="stylist-loading"><LoadingLine>Reading your wardrobe, live weather, and saved style…</LoadingLine><div className="loading-rule"><span /></div></div>}
